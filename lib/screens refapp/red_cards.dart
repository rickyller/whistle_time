...
class ExpulsionSelectionScreen extends StatefulWidget {
  @override
  _ExpulsionSelectionScreenState createState() => _ExpulsionSelectionScreenState();
}

class _ExpulsionSelectionScreenState extends State<ExpulsionSelectionScreen> {
  String? _selectedCause; // Causal seleccionada
  int? _selectedPlayer = 1; // Jugador 1 seleccionado por defecto

  final List<String> causes = [
    '1: DOGSO',
    '2: Evitar gol con infracción',
    '3: Juego brusco y grave',
    '4: Escupir o morder',
    '5: Conducta violenta',
    '6: Lenguaje ofensivo o insultante',
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              // Subtítulo debajo del título "Expulsiones"
              Text(
                "Liverpool",
                style: TextStyle(
